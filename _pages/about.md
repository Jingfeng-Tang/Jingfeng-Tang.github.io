...
# 🧱 Projects
- *2024.08 - 2024.08*, Motivated by [BAS](https://arxiv.org/pdf/2309.12943v1), I designed [Image-Doodler](https://github.com/Jingfeng-Tang/Image-Doodler) to generate a mask that occludes arbitrary regions (semantic features) of the image. It can help to observe the changes in the class activation map in different masking situations. You can download .exe form [Google Drive](https://drive.google.com/file/d/1hJPo0ULw1BCam8qFI9kgRg8rKyb-rKHC/view?usp=drive_link) or [Baidu Drive](https://pan.baidu.com/s/1wu4Wy8Oqo5M-JImIJSSidg?pwd=pwvw)
